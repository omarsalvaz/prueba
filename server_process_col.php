<?php
	/*
		* Script:    Tablas multiples con datos del lado del servidor para PHP y MySQL
		* Copyright: 2023 - Omar Saldaña
		* License:   Estandar (V.v. 1.0.1)
	*/
	...
	$aColumnas = array('id', 'fecha', 'fondo', 'seccion', 'subseccion');
